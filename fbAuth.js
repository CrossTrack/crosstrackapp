...
//       var activ = new Firebase('https://activ8.firebaseio.com/');
//       // var auth = new FirebaseSimpleLogin(activ, function(error, user) {
//       activ.authWithOAuthRedirect("facebook", function(error) {
//         remember: "default"
//         if (error) {
